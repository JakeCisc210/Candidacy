...
def ode_system(t,p,A,B):
  ...
  phi_vector1 = activation_function(value_difference1)
  phi_vector2 = activation_function(value_difference2)
...
def bnn_ode_solver(p1,p2,A,B,h,T):
  ...
  def ode_system_2(p):
    ...
    if step_size == .01 and (index == 0 or index == N-1):
        print(np.hstack((phi_vector1,phi_vector2)))
